...
As::TextEditor::TextEditor()
{
    ...
    connect(this, &CodeEditor::cursorPositionChanged, this, &As::TextEditor::getCursorPosition);
    connect(this, &CodeEditor::cursorPositionChanged, this, &As::TextEditor::highlightCurrentLine);
}
