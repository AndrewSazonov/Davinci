...
/*!
    \variable As::REDUCED_VERTICAL_SPACING
    \brief the vertical space between the rows in the sidebar group, which present the
    info in table form. Used to reduce the space betwen the text lines.
*/
const int As::REDUCED_VERTICAL_SPACING = 7;
