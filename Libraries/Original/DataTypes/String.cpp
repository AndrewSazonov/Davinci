...
*/
// https://bytes.com/topic/c/answers/136531-void-operator
//void operator=(const QString &other) {
//    m_string = other; }
QString &As::String::operator=(const QString &other)
{
    m_string = other;
    return m_string;
}
...
{
    return m_string.QString::startsWith(subString);
}

/*!
Appends the string \a other onto the end of this string.
*/
void As::String::append(const QString &other)
{
    m_string.QString::append(other);
}
...
{
    return m_string.QString::replace(before, after);
}
...
{
    return m_string.QString::remove(subString);
}
...
{
    return m_string.QString::mid(position, n);
}
